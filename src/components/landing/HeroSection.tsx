...
{/* Rotated white logo — right edge, mobile only */}
<div
  className="pointer-events-none absolute bottom-0 right-0 top-0 flex select-none items-center md:hidden"
  aria-hidden="true"
>
  <Image
    ...
    style={{ width: 500, height: "auto", opacity: 0.08 }}
    priority
  />
</div>
        <div>
